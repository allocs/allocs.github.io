  ...
  if (gameStarted){
    return (
      <div className='font-mono bg-backgroundblack h-[calc(100vh-81px)] w-screen'>
        ...
        <div className='font-mono text-outlinebrown text-2xl md:text-3xl lg:text-4xl xl:text-6xl font-bold py-2  justify-center  w-screen'>
    ...
    <div className='font-mono border border-b-8 border-backgroundblack bg-backgroundblack h-[calc(100vh-81px)]'>
      <div className='grid grid-cols-3 bg-buttongold items-center justify-center border-8 border-backgroundblack'>
        ...
        {}<div>
        <button className='bg-buttongold hover:bg-buttondarkgold text-outlinebrown font-bold py-2 px-4 border-2 border-outlinebrown border-b-8 rounded-full' onClick={() => startSession()}>START</button>
        </div>
        <br/>
      </div>
