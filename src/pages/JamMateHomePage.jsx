...
const HomePage = () => {
  return (
    <div className=' grid grid-col'>
        <section className="flex flex-wrap h-[calc(100vh-175px)] md:h-[calc(100vh-208px)] space-x-8 items-center bg-amp border-8 border-backgroundblack py-4">
            <div className='flex flex-col lg:flex-row flex-wrap space-x-8 items-center gap-4  m-auto justify-around'>
            <div className='flex'>
                <Link
                    to="/JamMate/HostGame"
            ...
            <Link
                to='/JamMate/HowTo'
                className='items-center self-center justify-self-center font-mono text-xl lg:text-2xl bg-buttongold hover:bg-buttondarkgold  text-outlinebrown font-bold py-2 px-4 border-2 border-outlinebrown border-b-8 hover:border-b-4 rounded-full'
                role="button"
            >
                HOW TO
            </Link>
